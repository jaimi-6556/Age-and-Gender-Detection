...
def main():
        ...
        with st.spinner("Analyzing images..."):
            ...
            for i, uploaded_file in enumerate(uploaded_files):
                ...
                with st.container():
                    ...
                    # Display uploaded imagepip install --upgrade pip setuptools
    ...
    elif st.button("Detect Age & Gender", key="no_image_button"):

        st.info("Please upload one or more images first.")

    # Footer
    st.markdown(
        '<div class="app-footer">Powered by Ahir Jaimi🧑‍💻</div>', unsafe_allow_html=True
    )
